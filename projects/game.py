...
themes = {
    ...
    "ice_cream": ["vanilla", "chocolate", "strawberry", "blueberry", "cottoncandy", "mintchocolatechip", "mint", "cookiedough", "rockyroad", "cookiesandcream", "pistachio", "butterpecan"],
